# Глоссарий Flow.Master

Этот раздел содержит ключевые термины и определения, используемые в системе Flow.Master.
...
Физическое лицо, получившее доступ к Рабочему пространству Flow.Master.  
